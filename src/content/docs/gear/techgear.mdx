---
title: Tech Gear
description: All the necessary gear to have to be a digital nomad
sidebar:
    order: 0
---
...
**Must-have requirements**: 1 USB-C connector, 1 jack 3.5 TRRS, Bluetooth 5+, nfc, fingerprint sensor.
...
**Must-have requirements**: Open ear, air conduction, wired with jack 3.5 TRRS, built in microphone, 90 degrees jack.
...
**Must-have requirements**: Air conduction, wired with jack 3.5 TRRS, built in microphone, 90 degrees jack.
...
<TabItem label="Medium budget">COMING SOON</TabItem>
<TabItem label="Unlimited budget">COMING SOON</TabItem>
</Tabs>
...
<TabItem label="Unlimited budget">https://a.co/d/flNEcLQ</TabItem>
</Tabs>
...
**Suggestions:** https://a.co/d/0i7DK8Ai
...
This is to connect your phone to rental cars.

Note that the 90 degrees jack port goes into your phone.

**Must-have requirements**: 3.5mm TRRS, 1m lenght, 90 degrees jack.

**Suggestions**: https://a.co/d/0a3qZ4dz
