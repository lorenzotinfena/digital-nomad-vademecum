...
**Nice-to-have requirements**: e-sim support, waterproof
...
If you want to connect external display you will use the same port of the vr headset.
...
- On battery: The only peripheral you can attach are headphones (jack), phone (usb-c), mouse (usb-c) and vr headset/displays (thunderbolt), if you need to connect more peripherals consider using the first approach.

**Must-have requirements**: Bluetooth 5, Convertible, 1 port Jack 3.5 TRRS, 1 thunderbolt 4 port, 2 USB-C port (another one), built in microphone, built in webcam.
...
**Additional requirements**: 1 more thunderbolt 4 port
...
**Nice-to-have requirements**: Dynamic amoled screen, active stylus, fingerprint reader, 1 USB-C port (another one).
...
This dock is useful for the laptop, but also as a charger of devices that you don't necessary want to connect to the laptop.

The thunderbolt ports are for the host and the vr headset/display, the 5 USB-C are for the phone, a flash drive, mouse, keyboard and powerbank/electric shaver, the ethernet and the jack are self-explanatory.

**Must-have requirements**: 2 thunderbolt 4 port (including the host port), 1 Ethernet, 1 3.5mm TRRS jack, 5 USB-C ports.
...
**Nice-to-have requirements**: Micro sd reader, 2 USB-C
...
**Custom quantity: ** As many as you need.
...
## Thunderbolt 4 1m cable

This is to connect the laptop to the dock

**Suggestions:** https://a.co/d/08jWOqWY

## Thunderbolt 4 3m cable

**Custom quantity: ** 1 to connect the vr/display to the dock and optionally another one to connect an external procesing unit (for example GPU) to the dock.
