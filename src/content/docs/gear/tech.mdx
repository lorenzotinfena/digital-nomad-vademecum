...
**Requirements**: Bluetooth 5, Convertible, 1 port Jack 3.5 TRRS, 1 thunderbolt 4 port, 2 USB-C port (another one), built in microphone, built in webcam.
...
**Requirements**: 2 thunderbolt 4 port (including the host port), 1 Ethernet, 1 3.5mm TRRS jack, 5 USB-C ports.
...
**Requirements**: Mechanical, brown switches, 75% layout, US ANSI layout, USB-C port

**Optional requirements**: PBT keycaps, Blank keycaps
...
**Requirements**: Version must be at least 3.2
